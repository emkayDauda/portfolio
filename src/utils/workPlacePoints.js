export default {
  monovo: [
    "Monovo is a MedTech company focused on improving the quality of life for the elderly.",
    "At Monovo, I lead the android team to build efficient native apps that monitor patient vitals and provide helpful insights.",
    "We are building the Monovo Patient App used by hundreds of people everyday, from the elderly, to people at risk of heart disease, among other things.",
    "Technologies I work with daily at Monovo include:",
    "Kotlin, Jetpack Compose, Firebase, Bluetooth (BLE), etc",
  ],
  bp: [
    "BuyPower is a YCombinator (W17) company simplifying consumer payments for utilities and energy across Nigeria.",
    "At BuyPower, I worked with a smart group of engineers in a fast-paced startup environment",
    "We built and maintained the BuyPower apps servicing Nigerians and accruing hundreds of thousands in revenue each day",
    "Technologies I worked with daily at BuyPower include:",
